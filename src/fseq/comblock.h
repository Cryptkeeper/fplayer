...
/// @param index index of the compression block to read, must be >= 0 and
/// < `curSequence.compressionBlockCount`
/// @return decompressed copy of the block's contained frame data, or NULL if an
/// error occurred
